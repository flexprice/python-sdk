...
from flexprice_client.api_client import ApiClient, RequestSerialized
from flexprice_client.api_response import ApiResponse
from flexprice_client.rest import RESTResponseType
...
class TasksApi:
    ...
    def tasks_id_process_post(
        ...
        _param = self._tasks_id_process_post_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def tasks_id_process_post_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Task ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def tasks_id_process_post_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Task ID")],
        _request_timeout: Union[
            None,
    ...
    def _tasks_id_process_post_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/tasks/{id}/process',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def tasks_id_status_put(
        self,
        id: Annotated[StrictStr, Field(description="Task ID")],
        status: Annotated[DtoUpdateTaskStatusRequest, Field(description="New status")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def tasks_post(
        self,
        task: Annotated[DtoCreateTaskRequest, Field(description="Task details")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
