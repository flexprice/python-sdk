...
```python
from flexprice import Flexprice, models
...
with Flexprice(
    ...
    res = f_client.alert_settings.create_alert_settings(config=models.AlertSettings(), entity_id="<id>", entity_type="feature")
...
with Flexprice(
    ...
    res = f_client.alert_settings.query_alert_settings()
...
with Flexprice(
    ...
    res = f_client.alert_settings.get_alert_settings(id="<id>")
...
with Flexprice(
    ...
    res = f_client.alert_settings.update_alert_settings(id="<id>", config=models.AlertSettings())
...
with Flexprice(
    ...
    f_client.alert_settings.delete_alert_settings(id="<id>")
