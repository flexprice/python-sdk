...
with Flexprice(
    ...
    res = f_client.checkout.create_checkout_session(action="create_subscription", customer_external_id="<id>", payment_provider="razorpay")
...
with Flexprice(
    ...
    res = f_client.checkout.get_checkout_session(id="<id>")
...
with Flexprice(
    ...
    f_client.checkout.delete_checkout_session(id="<id>")
