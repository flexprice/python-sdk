...
| `pause_end`                                                                                                                                                                                       | [date](https://docs.python.org/3/library/datetime.html#date-objects)                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                | End date for the subscription pause<br/>@Description ISO 8601 timestamp when the pause should end. Cannot be used together with pause_days. Must be after pause_start<br/>@Example "2024-02-15T00:00:00Z" |
| `pause_start`                                                                                                                                                                                     | [date](https://docs.python.org/3/library/datetime.html#date-objects)                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                | Start date for the subscription pause<br/>@Description ISO 8601 timestamp when the pause should begin. Required when pause_mode is "scheduled"<br/>@Example "2024-01-15T00:00:00Z"                |
...
**[models.SubscriptionPauseResponse](../../models/subscriptionpauseresponse.md)**
...
**[List[models.ListSubscriptionPausesResponse]](../../models/.md)**
