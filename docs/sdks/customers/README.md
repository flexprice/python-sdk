...
with Flexprice(
    ...
    res = f_client.customers.create_customer(external_id="<id>", name="<value>")
...
with Flexprice(
    ...
    res = f_client.customers.get_customer_entitlements_by_external_id(external_id="<id>")
...
with Flexprice(
    ...
    res = f_client.customers.get_subscriptions_for_customer(external_id="<id>")
