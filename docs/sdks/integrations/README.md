...
with Flexprice(
    ...
    res = f_client.integrations.link_integration_mapping(entity_id="<id>", entity_type="price", provider_entity_id="<id>", provider_type="<value>")
...
with Flexprice(
    ...
    res = f_client.integrations.delink_integration_mapping(entity_id="<id>", entity_type="item_price", provider_type="<value>")
