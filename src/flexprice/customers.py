...
class Customers(BaseSDK):
    def update_customer(
        ...
        *,
        ...
        integration_entity_mapping: Optional[
            Union[
                List[types.DtoIntegrationEntityMapping],
                List[types.DtoIntegrationEntityMappingTypedDict],
            ]
        ] = None,
        ...
        request = dtos.UpdateCustomerRequest(
            ...
            body=types.DtoUpdateCustomerRequest(
                ...
                integration_entity_mapping=utils.get_pydantic_model(
                    ...
                    Optional[List[types.DtoIntegrationEntityMapping]],
                ),
                metadata=metadata,
                name=name,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdateCustomerRequest
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoCustomerResponse, http_res)
    ...
    def create_customer(
        ...
        *,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateCustomerRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def query_customer(
        ...
        *,
        ...
        order: Optional[types.CustomerFilterOrder] = None,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoListCustomersResponse:
        r"""Query customers
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.CustomerFilter
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListCustomersResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def get_customer_usage_summary(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoCustomerUsageSummaryResponse:
        ...
        request = dtos.GetCustomerUsageSummaryRequest(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                types.DtoCustomerUsageSummaryResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
    ...
    def get_customer_entitlements(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoCustomerEntitlementsResponse:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                types.DtoCustomerEntitlementsResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
