...
class Tasks(BaseSDK):
    def list_tasks(
        ...
        *,
        ...
        entity_type: Optional[dtos.EntityType] = None,
        expand: Optional[str] = None,
        limit: Optional[int] = None,
        offset: Optional[int] = None,
        order: Optional[dtos.ListTasksOrder] = None,
        scheduled_task_id: Optional[str] = None,
        sort: Optional[str] = None,
        start_time: Optional[str] = None,
        status: Optional[dtos.ListTasksStatus] = None,
        task_status: Optional[dtos.TaskStatus] = None,
        task_type: Optional[dtos.TaskType] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoListTasksResponse:
        r"""List tasks
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListTasksResponse, http_res)
    ...
    def create_task(
        ...
        *,
        ...
        request = types.DtoCreateTaskRequest(
            entity_type=entity_type,
            file_name=file_name,
            file_type=file_type,
            file_url=file_url,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateTaskRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "202", "application/json"):
            return unmarshal_json_response(types.DtoTaskResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def get_task_result(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.ModelsTemporalWorkflowResult:
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.ModelsTemporalWorkflowResult, http_res)
    ...
    def update_task_status(
        ...
        *,
        ...
        request = dtos.UpdateTaskStatusRequest(
            id=id,
            body=types.DtoUpdateTaskStatusRequest(
                task_status=task_status,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdateTaskStatusRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
