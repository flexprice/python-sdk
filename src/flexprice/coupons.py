...
class Coupons(BaseSDK):
    def create_coupon(
        self,
        *,
        cadence: types.CouponCadence,
        name: str,
        type_: types.CouponType,
        ...
        request = types.DtoCreateCouponRequest(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateCouponRequest
            ),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoCouponResponse, http_res)
    ...
    def query_coupon(
        ...
        *,
        ...
        order: Optional[types.CouponFilterOrder] = None,
        sort: Optional[
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.CouponFilter
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListCouponsResponse, http_res)
    ...
    def update_coupon(
        ...
        *,
        ...
        request = dtos.UpdateCouponRequest(
            id=id,
            body=types.DtoUpdateCouponRequest(
                metadata=metadata,
                name=name,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdateCouponRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
