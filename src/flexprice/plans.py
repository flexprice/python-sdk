...
class Plans(BaseSDK):
        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreatePlanRequest
            ),
    ...
    def query_plan(
        ...
        *,
        ...
        order: Optional[types.PlanFilterOrder] = None,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.PlanFilter
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListPlansResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def update_plan(
        ...
        *,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdatePlanRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def post_plans_id_clone(
        ...
        *,
        ...
        request = dtos.PostPlansIDCloneRequest(
            id=id,
            body=types.DtoClonePlanRequest(
                description=description,
                display_order=display_order,
                lookup_key=lookup_key,
                metadata=metadata,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoClonePlanRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
