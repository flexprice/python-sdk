...
class UsageAnalyticItemTypedDict(TypedDict):
    ...
    addon: NotRequired[Addon2TypedDict]
    ...
    feature: NotRequired[Feature2TypedDict]
    ...
    plan: NotRequired[Plan2TypedDict]
...
class UsageAnalyticItem(BaseModel):
    ...
    feature: Optional[Feature2] = None
