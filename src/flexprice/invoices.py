...
class Invoices(BaseSDK):
        ...
        *,
    ...
    ) -> types.DtoCustomerMultiCurrencyInvoiceSummary:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                types.DtoCustomerMultiCurrencyInvoiceSummary, http_res
            )
    ...
    def create_invoice(
        ...
        *,
        ...
        billing_reason: Optional[types.InvoiceBillingReason] = None,
        coupons: Optional[List[str]] = None,
        description: Optional[str] = None,
        due_date: Optional[str] = None,
        idempotency_key: Optional[str] = None,
        invoice_coupons: Optional[
            Union[List[types.DtoInvoiceCoupon], List[types.DtoInvoiceCouponTypedDict]]
        ] = None,
        invoice_number: Optional[str] = None,
        invoice_pdf_url: Optional[str] = None,
        invoice_status: Optional[types.InvoiceStatus] = None,
        invoice_type: Optional[types.InvoiceType] = None,
        line_item_coupons: Optional[
            Union[
                List[types.DtoInvoiceLineItemCoupon],
                List[types.DtoInvoiceLineItemCouponTypedDict],
            ]
        ] = None,
        line_items: Optional[
            Union[
                List[types.DtoCreateInvoiceLineItemRequest],
                List[types.DtoCreateInvoiceLineItemRequestTypedDict],
            ]
        ] = None,
        metadata: Optional[Dict[str, str]] = None,
        payment_status: Optional[types.PaymentStatus] = None,
        period_end: Optional[str] = None,
        period_start: Optional[str] = None,
        prepared_tax_rates: Optional[
            Union[
                List[types.DtoTaxRateResponse], List[types.DtoTaxRateResponseTypedDict]
            ]
        ] = None,
        ...
        request = types.DtoCreateInvoiceRequest(
            ...
            invoice_coupons=utils.get_pydantic_model(
                invoice_coupons, Optional[List[types.DtoInvoiceCoupon]]
            ),
            ...
            line_item_coupons=utils.get_pydantic_model(
                line_item_coupons, Optional[List[types.DtoInvoiceLineItemCoupon]]
            ),
            line_items=utils.get_pydantic_model(
                line_items, Optional[List[types.DtoCreateInvoiceLineItemRequest]]
            ),
            metadata=metadata,
            ...
            prepared_tax_rates=utils.get_pydantic_model(
                prepared_tax_rates, Optional[List[types.DtoTaxRateResponse]]
            ),
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateInvoiceRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoInvoiceResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def get_invoice_preview(
        ...
        *,
        ...
        request = types.DtoGetPreviewInvoiceRequest(
            period_end=period_end,
            period_start=period_start,
            subscription_id=subscription_id,
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoGetPreviewInvoiceRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def query_invoice(
        ...
        *,
        ...
        invoice_status: Optional[List[types.InvoiceStatus]] = None,
        invoice_type: Optional[types.InvoiceType] = None,
        limit: Optional[int] = None,
        offset: Optional[int] = None,
        order: Optional[types.InvoiceFilterOrder] = None,
        payment_status: Optional[List[types.PaymentStatus]] = None,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.InvoiceFilter
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListInvoicesResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def update_invoice(
        ...
        *,
        ...
        request = dtos.UpdateInvoiceRequest(
            id=id,
            body=types.DtoUpdateInvoiceRequest(
                due_date=due_date,
                invoice_pdf_url=invoice_pdf_url,
                metadata=metadata,
            ),
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdateInvoiceRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def update_invoice_payment_status(
        ...
        *,
        ...
        request = dtos.UpdateInvoicePaymentStatusRequest(
            id=id,
            body=types.DtoUpdatePaymentStatusRequest(
                amount=amount,
                payment_status=payment_status,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdatePaymentStatusRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
