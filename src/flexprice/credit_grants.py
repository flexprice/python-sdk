...
class CreditGrants(BaseSDK):
    def create_credit_grant(
        ...
        *,
        ...
        expiration_duration_unit: Optional[types.CreditGrantExpiryDurationUnit] = None,
        expiration_type: Optional[types.CreditGrantExpiryType] = None,
        metadata: Optional[Dict[str, str]] = None,
        period: Optional[types.CreditGrantPeriod] = None,
        ...
        request = types.DtoCreateCreditGrantRequest(
            cadence=cadence,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateCreditGrantRequest
            ),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoCreditGrantResponse, http_res)
    ...
    def update_credit_grant(
        ...
        *,
        ...
        request = dtos.UpdateCreditGrantRequest(
            id=id,
            body=types.DtoUpdateCreditGrantRequest(
                metadata=metadata,
                name=name,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdateCreditGrantRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def delete_credit_grant(
        ...
        *,
        ...
        request = dtos.DeleteCreditGrantRequest(
            id=id,
            body=types.DtoDeleteCreditGrantRequest(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[types.DtoDeleteCreditGrantRequest],
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_plan_credit_grants(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoListCreditGrantsResponse:
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListCreditGrantsResponse, http_res)
