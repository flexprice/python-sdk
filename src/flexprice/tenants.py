    ...
    def get_tenant_billing_usage(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoTenantBillingUsage, http_res)
    ...
    def update_tenant(
        ...
        *,
        billing_details: Optional[
            Union[types.DtoTenantBillingDetails, types.DtoTenantBillingDetailsTypedDict]
        ] = None,
        ...
        request = types.DtoUpdateTenantRequest(
            billing_details=utils.get_pydantic_model(
                billing_details, Optional[types.DtoTenantBillingDetails]
            ),
            metadata=metadata,
            name=name,
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoUpdateTenantRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoTenantResponse, http_res)
        if utils.match_response(http_res, ["400", "404"], "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
