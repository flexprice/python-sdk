...
class TaxRates(BaseSDK):
    def get_tax_rates(
        ...
        *,
        ...
        order: Optional[dtos.GetTaxRatesOrder] = None,
        scope: Optional[dtos.Scope] = None,
        start_time: Optional[str] = None,
        status: Optional[dtos.GetTaxRatesStatus] = None,
        ...
        request = dtos.GetTaxRatesRequest(
            end_time=end_time,
            expand=expand,
            limit=limit,
            offset=offset,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[types.DtoTaxRateResponse], http_res)
    ...
    def create_tax_rate(
        ...
        *,
        ...
        scope: Optional[types.TaxRateScope] = None,
        tax_rate_type: Optional[types.TaxRateType] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoTaxRateResponse:
        r"""Create a tax rate
        ...
        request = types.DtoCreateTaxRateRequest(
            code=code,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateTaxRateRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoTaxRateResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def update_tax_rate(
        ...
        *,
        ...
        tax_rate_status: Optional[types.TaxRateStatus] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = dtos.UpdateTaxRateRequest(
            id=id,
            body=types.DtoUpdateTaxRateRequest(
                code=code,
                description=description,
                metadata=metadata,
                name=name,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdateTaxRateRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
