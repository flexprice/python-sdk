...
class Prices(BaseSDK):
    def create_price(
        ...
        *,
        ...
        price_unit_config: Optional[
            Union[types.DtoPriceUnitConfig, types.DtoPriceUnitConfigTypedDict]
        ] = None,
        ...
        request = types.DtoCreatePriceRequest(
            amount=amount,
            ...
            price_unit_config=utils.get_pydantic_model(
                price_unit_config, Optional[types.DtoPriceUnitConfig]
            ),
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreatePriceRequest
            ),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoPriceResponse, http_res)
    ...
    def create_prices_bulk(
        ...
        *,
        items: Union[
            List[types.DtoCreatePriceRequest],
            List[types.DtoCreatePriceRequestTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoCreateBulkPriceResponse:
        ...
        request = types.DtoCreateBulkPriceRequest(
            items=utils.get_pydantic_model(items, List[types.DtoCreatePriceRequest]),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateBulkPriceRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoCreateBulkPriceResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def query_price(
        ...
        *,
        ...
        entity_type: Optional[types.PriceEntityType] = None,
        ...
        order: Optional[types.PriceFilterOrder] = None,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.PriceFilter
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListPricesResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def update_price(
        ...
        *,
        ...
        request = dtos.UpdatePriceRequest(
            id=id,
            body=types.DtoUpdatePriceRequest(
                amount=amount,
                billing_model=billing_model,
                description=description,
                display_name=display_name,
                ...
                price_unit_tiers=utils.get_pydantic_model(
                    price_unit_tiers, Optional[List[types.DtoCreatePriceTier]]
                ),
                tier_mode=tier_mode,
                tiers=utils.get_pydantic_model(
                    tiers, Optional[List[types.DtoCreatePriceTier]]
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdatePriceRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def delete_price(
        ...
        *,
        ...
        request = dtos.DeletePriceRequest(
            id=id,
            body=types.DtoDeletePriceRequest(
                end_date=end_date,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoDeletePriceRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
