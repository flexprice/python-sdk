...
class Wallets(BaseSDK):
    def get_customer_wallets(
        ...
        *,
        ...
        request = dtos.GetCustomerWalletsRequest(
            minus=minus,
            expand=expand,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[types.DtoWalletResponse], http_res)
    ...
    def create_wallet(
        ...
        *,
        ...
        auto_topup: Optional[Union[types.AutoTopup, types.AutoTopupTypedDict]] = None,
        ...
        wallet_type: Optional[types.WalletType] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoWalletResponse:
        ...
        request = types.DtoCreateWalletRequest(
            alert_settings=utils.get_pydantic_model(
                alert_settings, Optional[types.AlertSettings]
            ),
            auto_topup=utils.get_pydantic_model(auto_topup, Optional[types.AutoTopup]),
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateWalletRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoWalletResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def query_wallet(
        ...
        *,
        ...
        order: Optional[types.WalletFilterOrder] = None,
        sort: Optional[str] = None,
        status: Optional[types.WalletStatus] = None,
        wallet_ids: Optional[List[str]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.ListResponseDtoWalletResponse:
        r"""Query wallets
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.WalletFilter
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                types.ListResponseDtoWalletResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
    ...
    def query_wallet_transaction(
        ...
        *,
        ...
        limit: Optional[int] = None,
        offset: Optional[int] = None,
        order: Optional[types.WalletTransactionFilterOrder] = None,
        ...
        transaction_reason: Optional[types.TransactionReason] = None,
        transaction_status: Optional[types.TransactionStatus] = None,
        type_: Optional[types.TransactionType] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoListWalletTransactionsResponse:
        ...
        request = types.WalletTransactionFilter(
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.WalletTransactionFilter
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                types.DtoListWalletTransactionsResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
    ...
    def update_wallet(
        ...
        *,
        ...
        auto_topup: Optional[Union[types.AutoTopup, types.AutoTopupTypedDict]] = None,
        config: Optional[Union[types.WalletConfig, types.WalletConfigTypedDict]] = None,
        description: Optional[str] = None,
        metadata: Optional[Dict[str, str]] = None,
        ...
        request = dtos.UpdateWalletRequest(
            id=id,
            body=types.DtoUpdateWalletRequest(
                alert_settings=utils.get_pydantic_model(
                    alert_settings, Optional[types.AlertSettings]
                ),
                auto_topup=utils.get_pydantic_model(
                    auto_topup, Optional[types.AutoTopup]
                ),
                config=utils.get_pydantic_model(config, Optional[types.WalletConfig]),
                description=description,
                metadata=metadata,
                name=name,
            ),
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdateWalletRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_wallet_balance(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoWalletBalanceResponse:
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoWalletBalanceResponse, http_res)
        if utils.match_response(http_res, ["400", "404"], "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def top_up_wallet(
        ...
        *,
        ...
        request = dtos.TopUpWalletRequest(
            id=id,
            body=types.DtoTopUpWalletRequest(
                amount=amount,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoTopUpWalletRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoTopUpWalletResponse, http_res)
        if utils.match_response(http_res, ["400", "404"], "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def get_wallet_transactions(
        ...
        *,
        ...
        limit: Optional[int] = None,
        offset: Optional[int] = None,
        order: Optional[dtos.GetWalletTransactionsOrder] = None,
        priority: Optional[int] = None,
        reference_id: Optional[str] = None,
        reference_type: Optional[str] = None,
        start_time: Optional[str] = None,
        status: Optional[dtos.GetWalletTransactionsStatus] = None,
        transaction_reason: Optional[dtos.TransactionReason] = None,
        transaction_status: Optional[dtos.TransactionStatus] = None,
        type_: Optional[dtos.Type] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = dtos.GetWalletTransactionsRequest(
