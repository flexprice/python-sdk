...
class TaxAssociations(BaseSDK):
        ...
        *,
    ...
    ) -> types.DtoListTaxAssociationsResponse:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                types.DtoListTaxAssociationsResponse, http_res
            )
    ...
    def create_tax_association(
        ...
        *,
        ...
        entity_id: Optional[str] = None,
        entity_type: Optional[types.TaxRateEntityType] = None,
        external_customer_id: Optional[str] = None,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoTaxAssociationResponse:
        ...
        request = types.DtoCreateTaxAssociationRequest(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateTaxAssociationRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoTaxAssociationResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def update_tax_association(
        ...
        *,
        ...
        request = dtos.UpdateTaxAssociationRequest(
            id=id,
            body=types.DtoTaxAssociationUpdateRequest(
                auto_apply=auto_apply,
                metadata=metadata,
                priority=priority,
            ),
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoTaxAssociationUpdateRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
