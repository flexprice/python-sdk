...
class PriceUnits(BaseSDK):
    def list_price_units(
        ...
        *,
        ...
        order: Optional[dtos.ListPriceUnitsOrder] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoListPriceUnitsResponse:
        r"""List price units
        ...
        request = dtos.ListPriceUnitsRequest(
            status=status,
            limit=limit,
            offset=offset,
            sort=sort,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListPriceUnitsResponse, http_res)
    ...
    def create_price_unit(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoCreatePriceUnitResponse:
        r"""Create price unit
        ...
        request = types.DtoCreatePriceUnitRequest(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreatePriceUnitRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoCreatePriceUnitResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def get_price_unit_by_code(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoPriceUnitResponse, http_res)
    ...
    def query_price_unit(
        ...
        *,
        ...
        order: Optional[types.PriceUnitFilterOrder] = None,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.PriceUnitFilter
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def update_price_unit(
        ...
        *,
        ...
        request = dtos.UpdatePriceUnitRequest(
            id=id,
            body=types.DtoUpdatePriceUnitRequest(
                metadata=metadata,
                name=name,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdatePriceUnitRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
