...
class CreditNotes(BaseSDK):
    def create_credit_note(
        ...
        *,
        ...
        line_items: Optional[
            Union[
                List[types.DtoCreateCreditNoteLineItemRequest],
                List[types.DtoCreateCreditNoteLineItemRequestTypedDict],
            ]
        ] = None,
        ...
        request = types.DtoCreateCreditNoteRequest(
            credit_note_number=credit_note_number,
            idempotency_key=idempotency_key,
            invoice_id=invoice_id,
            line_items=utils.get_pydantic_model(
                line_items, Optional[List[types.DtoCreateCreditNoteLineItemRequest]]
            ),
            memo=memo,
            metadata=metadata,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateCreditNoteRequest
            ),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoCreditNoteResponse, http_res)
