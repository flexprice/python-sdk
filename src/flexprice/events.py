...
class Events(BaseSDK):
    def ingest_event(
        ...
        *,
        ...
        request = types.DtoIngestEventRequest(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoIngestEventRequest
            ),
    ...
    def get_usage_analytics(
        ...
        *,
        ...
        window_size: Optional[types.WindowSize] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoGetUsageAnalyticsResponse:
        ...
        request = types.DtoGetUsageAnalyticsRequest(
            end_time=end_time,
            expand=expand,
            external_customer_id=external_customer_id,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoGetUsageAnalyticsRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoGetUsageAnalyticsResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def ingest_events_bulk(
        ...
        *,
        events: Union[
            List[types.DtoIngestEventRequest],
            List[types.DtoIngestEventRequestTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = types.DtoBulkIngestEventRequest(
            events=utils.get_pydantic_model(events, List[types.DtoIngestEventRequest]),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoBulkIngestEventRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_huggingface_inference_data(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoGetHuggingFaceBillingDataResponse:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                types.DtoGetHuggingFaceBillingDataResponse, http_res
            )
        if utils.match_response(http_res, "500", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
    ...
    def list_raw_events(
        ...
        *,
        ...
        request = types.DtoGetEventsRequest(
            end_time=end_time,
            event_id=event_id,
            event_name=event_name,
            external_customer_id=external_customer_id,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoGetEventsRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoGetEventsResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def get_usage_statistics(
        ...
        *,
        ...
        bucket_size: Optional[types.WindowSize] = None,
        customer_id: Optional[str] = None,
        end_time: Optional[str] = None,
        external_customer_id: Optional[str] = None,
        ...
        request = types.DtoGetUsageRequest(
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoGetUsageRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoGetUsageResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def get_usage_by_meter(
        ...
        *,
        ...
        request = types.DtoGetUsageByMeterRequest(
            billing_anchor=billing_anchor,
            bucket_size=bucket_size,
            customer_id=customer_id,
            end_time=end_time,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoGetUsageByMeterRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_event(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoGetEventByIDResponse, http_res)
