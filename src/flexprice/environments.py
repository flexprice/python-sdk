...
class Environments(BaseSDK):
    def create_environment(
        ...
        *,
        ...
        request = types.DtoCreateEnvironmentRequest(
            name=name,
            type=type_,
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateEnvironmentRequest
            ),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoEnvironmentResponse, http_res)
    ...
    def update_environment(
        ...
        *,
        ...
        request = dtos.UpdateEnvironmentRequest(
            id=id,
            body=types.DtoUpdateEnvironmentRequest(
                name=name,
                type=type_,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdateEnvironmentRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
