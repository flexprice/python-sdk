...
class Integrations(BaseSDK):
    def get_integration(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoSecretResponse, http_res)
    ...
    def create_or_update_integration(
        ...
        *,
        ...
        request = dtos.CreateOrUpdateIntegrationRequest(
            ...
            body=types.DtoCreateIntegrationRequest(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoCreateIntegrationRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def list_linked_integrations(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoLinkedIntegrationsResponse:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                types.DtoLinkedIntegrationsResponse, http_res
            )
        if utils.match_response(http_res, "500", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
