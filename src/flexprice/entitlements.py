...
class Entitlements(BaseSDK):
    def get_addon_entitlements(
        ...
        *,
    ...
    ) -> types.DtoListEntitlementsResponse:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListEntitlementsResponse, http_res)
    ...
    def create_entitlement(
        ...
        *,
        ...
        entity_type: Optional[types.EntitlementEntityType] = None,
        ...
        usage_reset_period: Optional[types.EntitlementUsageResetPeriod] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoEntitlementResponse:
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateEntitlementRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoEntitlementResponse, http_res)
    ...
    def create_entitlements_bulk(
        ...
        *,
        items: Union[
            List[types.DtoCreateEntitlementRequest],
            List[types.DtoCreateEntitlementRequestTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoCreateBulkEntitlementResponse:
        ...
        request = types.DtoCreateBulkEntitlementRequest(
            items=utils.get_pydantic_model(
                items, List[types.DtoCreateEntitlementRequest]
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreateBulkEntitlementRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                types.DtoCreateBulkEntitlementResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
    ...
    def query_entitlement(
        ...
        *,
        ...
        feature_type: Optional[types.FeatureType] = None,
        filters: Optional[
        ...
        order: Optional[types.EntitlementFilterOrder] = None,
        ...
        request = types.EntitlementFilter(
            end_time=end_time,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.EntitlementFilter
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def update_entitlement(
        ...
        *,
        ...
        request = dtos.UpdateEntitlementRequest(
            id=id,
            body=types.DtoUpdateEntitlementRequest(
                is_enabled=is_enabled,
                is_soft_limit=is_soft_limit,
                static_value=static_value,
                usage_limit=usage_limit,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdateEntitlementRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_plan_entitlements(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoPlanResponse, http_res)
        if utils.match_response(http_res, ["400", "404"], "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
