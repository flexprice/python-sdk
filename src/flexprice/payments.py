...
class Payments(BaseSDK):
    def list_payments(
        ...
        *,
        ...
        order: Optional[dtos.ListPaymentsOrder] = None,
        ...
        status: Optional[dtos.ListPaymentsStatus] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> types.DtoListPaymentsResponse:
        r"""List payments
        ...
        request = dtos.ListPaymentsRequest(
            currency=currency,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(types.DtoListPaymentsResponse, http_res)
    ...
    def create_payment(
        ...
        *,
        ...
        payment_gateway: Optional[types.PaymentGatewayType] = None,
        ...
        request = types.DtoCreatePaymentRequest(
            amount=amount,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", types.DtoCreatePaymentRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(types.DtoPaymentResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorsErrorResponseData, http_res
            )
    ...
    def update_payment(
        ...
        *,
        ...
        request = dtos.UpdatePaymentRequest(
            id=id,
            body=types.DtoUpdatePaymentRequest(
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", types.DtoUpdatePaymentRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
